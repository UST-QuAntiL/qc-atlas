...
@Component
public class QuantumResourceTypeAssembler extends GenericLinkAssembler<ComputingResourceTypeDto> {
    @Override
    public void addLinks(EntityModel<ComputingResourceTypeDto> resource) {
