...
public class Constants {
    ...
    public static final String COMPUTING_RESOURCES_PROPERTIES = "computing-resources";
    public static final String COMPUTING_RESOURCE_PROPERTY_TYPES = "computing-resource-types";
