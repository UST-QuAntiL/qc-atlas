...
public class ImplementationController {
    ...
    @PutMapping("/{implementationId}/" + Constants.IMPLEMENTATION_PACKAGES + "/{packageId}/")
    ...
    @DeleteMapping("/{implementationId}/" + Constants.IMPLEMENTATION_PACKAGES + "/{packageId}/")
    public HttpEntity<Void> deleteImplementationPackageOfImplementation(
        ...
        implementationService.checkIfImplementationIsOfAlgorithm(implementationId, algorithmId);
        implementationPackageService.checkIfImplementationPackageIsLinkedToImplementation(packageId, implementationId);
        implementationPackageService.delete(packageId);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }
}
