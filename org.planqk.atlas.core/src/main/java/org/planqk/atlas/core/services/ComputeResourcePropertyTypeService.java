...
public interface ComputeResourcePropertyTypeService {
     ...
     * The validation for this is done by the Controller layer, which will reject {@link ComputeResourcePropertyType}s
    ...
    /**
     * Find a database entry of a {@link ComputeResourcePropertyType} that is already saved in the database.
     * This search is based on the ID the database has given the {@link ComputeResourcePropertyType}
    ...
    /**
     * Update an existing {@link ComputeResourcePropertyType} database entry by saving the updated {@link ComputeResourcePropertyType}
     * object to the the database.
     * <p>
     * The ID of the {@link ComputeResourcePropertyType} parameter has to be set to the ID of the database entry we want to update.
     * The validation for this ID to be set is done by the Controller layer, which will reject {@link ComputeResourcePropertyType}s
     * without a given ID in its update path.
     * This ID will be used to query the existing {@link ComputeResourcePropertyType} entry we want to update.
     * If no {@link ComputeResourcePropertyType} entry with the given ID is found this method will throw a
    ...
    /**
     * Delete an existing {@link ComputeResourcePropertyType} entry from the database.
     * This deletion is based on the ID the database has given the {@link ComputeResourcePropertyType}
     ...
     * <p>
     * If the {@link ComputeResourcePropertyType} is still referenced by at least one {@link org.planqk.atlas.core.model.ComputeResourceProperty}
