...
public interface DiscussionTopicService {
     ...
     * The validation for this is done by the Controller layer, which will reject {@link DiscussionTopic}s with a given ID in
     * its create path.
     *
    ...
    /**
     * Find a database entry of a {@link DiscussionTopic} that is already saved in the database.
     * This search is based on the ID the database has given the {@link DiscussionTopic}
    ...
    /**
     * Update an existing {@link DiscussionTopic} database entry by saving the updated {@link DiscussionTopic} object
     * to the the database.
     * <p>
     ...
     * This ID will be used to query the existing {@link DiscussionTopic} entry we want to update.
     * If no {@link DiscussionTopic} entry with the given ID is found this method will throw a
    ...
    /**
     * Delete an existing {@link DiscussionTopic} entry from the database.
     * This deletion is based on the ID the database has given the {@link DiscussionTopic}
