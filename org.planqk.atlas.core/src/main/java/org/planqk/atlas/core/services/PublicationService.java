...
public interface PublicationService {
     ...
     * <p>
     * The ID of the {@link Publication} parameter should be null, since the ID will be generated by the database
     * when creating the entry.
     * The validation for this is done by the Controller layer, which will reject {@link Publication}s with a given ID in
     * its create path.
     *
    ...
    /**
     * Find a database entry of a {@link Publication} that is already saved in the database.
     * This search is based on the ID the database has given the {@link Publication}
    ...
    /**
     * Update an existing {@link Publication} database entry by saving the updated {@link Publication} object
     * to the the database.
     * <p>
     * The ID of the {@link Publication} parameter has to be set to the ID of the database entry we want to update.
     * The validation for this ID to be set is done by the Controller layer, which will reject {@link Publication}s
     * without a given ID in its update path.
     * This ID will be used to query the existing {@link Publication} entry we want to update.
     * If no {@link Publication} entry with the given ID is found this method will throw a
    ...
    /**
     * Delete an existing {@link Publication} entry from the database.
     * This deletion is based on the ID the database has given the {@link Publication}
     ...
     * <p>
     * Objects that can be related to multiple {@link Publication}s will not be deleted.
     * Only the reference to the deleted {@link Publication} will be removed from these objects.
     * These include {@link Algorithm}s and  {@link Implementation}s.
     *
    ...
    /**
     * <p>
     * Delete multiple existing {@link Publication} entry from the database.
     * This deletion is based on the ID the database has given the {@link Publication}s
     * when they were created and first saved to the database.
     * <p>
    ...
    /**
     * Retrieve multiple {@link Algorithm}s entries from the database of {@link Algorithm}s that are linked
     * to the given {@link Publication}
     ...
     * <p>
     * If either the {@link Algorithm} or the {@link Publication} with given IDs could not be found or
     ...
     * <p>
     * If either the {@link Implementation} or the {@link Publication} with given IDs could not be found or
     * if a database entry for both could be found but they are not linked a {@link java.util.NoSuchElementException}
     * is thrown.
     *
     * @param publicationId The ID of the {@link Publication} we want to check
