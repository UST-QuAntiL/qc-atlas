...
public interface SoftwarePlatformService {
    ...
    /**
     * Retrieve multiple {@link SoftwarePlatform} entries from the database where their name matches the name search
     ...
     *
     * @param name     The string based on which a search for {@link SoftwarePlatform}s with a matching name will be
     *                 executed
     ...
     * SoftwarePlatform}s with a given ID in its create path.
     *
    ...
    /**
     * Find a database entry of a {@link SoftwarePlatform} that is already saved in the database. This search is based
     * on the ID the database has given the {@link SoftwarePlatform} object when it was created and first saved to the
     * database.
     * <p>
     ...
     * without a given ID in its update path. This ID will be used to query the existing {@link SoftwarePlatform} entry
     * we want to update. If no {@link SoftwarePlatform} entry with the given ID is found this method will throw a
    ...
    /**
     * Delete an existing {@link SoftwarePlatform} entry from the database. This deletion is based on the ID the
     * database has given the {@link SoftwarePlatform} when it was created and first saved to the database.
     * <p>
     * Objects that can be related to multiple {@link SoftwarePlatform}s will not be deleted. Only the reference to the
     * deleted {@link SoftwarePlatform} will be removed from these objects. These include {@link Implementation}s,
     * {@link CloudService}s and {@link ComputeResource}s.
     * <p>
     ...
     * the given {@link SoftwarePlatform}. If no entries are found an empty page is returned.
     * <p>
     * The amount of entries is based on the given {@link Pageable} parameter. If the {@link Pageable} is unpaged a
     * {@link Page} with all entries is queried.
     * <p>
     ...
     * @param pageable           The page information, namely page size and page number, of the page we want to
     *                           retrieve
     ...
     * given {@link SoftwarePlatform}. If no entries are found an empty page is returned.
     * <p>
     * The amount of entries is based on the given {@link Pageable} parameter. If the {@link Pageable} is unpaged a
     * {@link Page} with all entries is queried.
     * <p>
     ...
     * to the given {@link SoftwarePlatform}. If no entries are found an empty page is returned.
     * <p>
     * The amount of entries is based on the given {@link Pageable} parameter. If the {@link Pageable} is unpaged a
     * {@link Page} with all entries is queried.
     * <p>
     ...
     * SoftwarePlatform} with the given ID can be found a {@link java.util.NoSuchElementException} is thrown.
     *
     * @param softwarePlatformId The ID of the {@link SoftwarePlatform} we want find linked {@link ComputeResource}s
     *                           for
     * @param pageable           The page information, namely page size and page number, of the page we want to
     *                           retrieve
     ...
     * <p>
     * If either the {@link SoftwarePlatform} or the {@link Implementation} with given IDs could not be found or if a
