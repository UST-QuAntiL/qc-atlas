...
public final class CollectionUtils {
    ...
    /**
     * Performs the given action for each element of the given @link Collection. To allow concurrent modifications the
     * collection is copied before iterating over it.
     *
