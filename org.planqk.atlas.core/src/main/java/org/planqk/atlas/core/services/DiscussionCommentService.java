...
public interface DiscussionCommentService {
     ...
     * DiscussionComment}s with a given ID in its create path.
     *
     ...
     * {@link Page} with all entries is queried.
     *
     * @param topicId  The ID of the {@link org.planqk.atlas.core.model.DiscussionTopic} we want to find {@link
     *                 DiscussionComment}s for
     * @param pageable The page information, namely page size and page number, of the page we want to retrieve
     * @return The page of queried {@link DiscussionComment} entries
     */
    ...
    /**
     * Find a database entry of a {@link DiscussionComment} that is already saved in the database. This search is based
     * on the ID the database has given the {@link DiscussionComment} object when it was created and first saved to the
     * database.
     * <p>
    ...
    /**
     * Update an existing {@link DiscussionComment} database entry by saving the updated {@link DiscussionComment}
     * object to the the database.
     * <p>
     * The ID of the {@link DiscussionComment} parameter has to be set to the ID of the database entry we want to
     * update. The validation for this ID to be set is done by the Controller layer, which will reject {@link
     * DiscussionComment}s without a given ID in its update path. This ID will be used to query the existing {@link
     * DiscussionComment} entry we want to update. If no {@link DiscussionComment} entry with the given ID is found this
    ...
    /**
     * Delete an existing {@link DiscussionComment} entry from the database. This deletion is based on the ID the
     * database has given the {@link DiscussionComment} when it was created and first saved to the database.
     * <p>
