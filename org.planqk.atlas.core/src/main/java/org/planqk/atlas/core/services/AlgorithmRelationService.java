...
public interface AlgorithmRelationService {
     ...
     * The validation for this is done by the Controller layer, which will reject {@link AlgorithmRelation}s with a given ID in
     * its create path.
     * <p>
    ...
    /**
     * Find a database entry of a {@link AlgorithmRelation} that is already saved in the database.
     * This search is based on the ID the database has given the {@link AlgorithmRelation}
    ...
    /**
     * Update an existing {@link AlgorithmRelation} database entry by saving the updated {@link AlgorithmRelation} object
     * to the the database.
     * <p>
     * The ID of the {@link AlgorithmRelation} parameter has to be set to the ID of the database entry we want to update.
     * The validation for this ID to be set is done by the Controller layer, which will reject {@link AlgorithmRelation}s
     * without a given ID in its update path.
     * This ID will be used to query the existing {@link AlgorithmRelation} entry we want to update.
     * If no {@link AlgorithmRelation} entry with the given ID is found this method will throw a
    ...
    /**
     * Delete an existing {@link AlgorithmRelation} entry from the database.
     * This deletion is based on the ID the database has given the {@link AlgorithmRelation}
