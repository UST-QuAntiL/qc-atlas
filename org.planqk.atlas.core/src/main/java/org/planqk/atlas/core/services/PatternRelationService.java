...
public interface PatternRelationService {
     ...
     * The validation for this is done by the Controller layer, which will reject {@link PatternRelation}s with a given ID in
     * its create path.
     * <p>
     * The {@link org.planqk.atlas.core.model.PatternRelationType} has to be set and can not be null.
     ...
     * If the {@link org.planqk.atlas.core.model.PatternRelationType} with given ID doesn't exist a
     * {@link java.util.NoSuchElementException} is thrown.
     * <p>
     * The same approach is taken for the algorithm of the {@link PatternRelation}.
     * All other properties of the {@link org.planqk.atlas.core.model.Algorithm} in the {@link PatternRelation}
     * parameter will be ignored, except the ID which will also be used to query the {@link org.planqk.atlas.core.model.Algorithm}
     * object from the database.
     * This way we will also check if the given {@link org.planqk.atlas.core.model.Algorithm} exists in the database
     * without another step checking for this.
     * If either of the algorithms don't exist a {@link java.util.NoSuchElementException} is thrown.
     *
     * @param patternRelation The {@link PatternRelation} object describing the relation between a source and a
    ...
    /**
     * Find a database entry of a {@link PatternRelation} that is already saved in the database.
     * This search is based on the ID the database has given the {@link PatternRelation}
    ...
    /**
     * Update an existing {@link PatternRelation} database entry by saving the updated {@link PatternRelation} object
     * to the the database.
     * <p>
     ...
     * This ID will be used to query the existing {@link PatternRelation} entry we want to update.
     * If no {@link PatternRelation} entry with the given ID is found this method will throw a
    ...
    /**
     * Delete an existing {@link PatternRelation} entry from the database.
     * This deletion is based on the ID the database has given the {@link PatternRelation}
    ...
    /**
     * Checks if a {@link org.planqk.atlas.core.model.Algorithm} is part of a {@link PatternRelation}.
     * In order to uniquely identify the {@link org.planqk.atlas.core.model.Algorithm} and the {@link PatternRelation}
     * their IDs, which are given as parameters to this method, will be used.
     * <p>
     * If there is no {@link PatternRelation} found with the ID given in the {@param patternRelationId} parameter or
     * if there is a {@link PatternRelation} found the algorithm doesn't match the ID given in the {@param algorithmId}
