...
public interface CloudServiceService {
    ...
    /**
     * Retrieve multiple {@link CloudService} entries from the database where their name matches the name search parameter.
     ...
     * <p>
     * The ID of the {@link CloudService} parameter should be null, since the ID will be generated by the database
    ...
    /**
     * Find a database entry of a {@link CloudService} that is already saved in the database.
     * This search is based on the ID the database has given the {@link CloudService}
    ...
    /**
     * Update an existing {@link CloudService} database entry by saving the updated {@link CloudService} object
     * to the the database.
     * <p>
     * The ID of the {@link CloudService} parameter has to be set to the ID of the database entry we want to update.
     * The validation for this ID to be set is done by the Controller layer, which will reject {@link CloudService}s
     * without a given ID in its update path.
     * This ID will be used to query the existing {@link CloudService} entry we want to update.
     * If no {@link CloudService} entry with the given ID is found this method will throw a
    ...
    /**
     * Delete an existing {@link CloudService} entry from the database.
     * This deletion is based on the ID the database has given the {@link CloudService}
     * when it was created and first saved to the database.
     * <p>
     * Objects that can be related to multiple {@link CloudService}s will not be deleted. Only the reference to the deleted
     * {@link CloudService} will be removed from these objects. These include {@link SoftwarePlatform}s and
     ...
     * to the given {@link CloudService}.
